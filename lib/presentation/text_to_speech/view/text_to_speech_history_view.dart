...
@immutable
final class TextToSpeechHistoryView extends ConsumerStatefulWidget {
  const TextToSpeechHistoryView({super.key});

  @override
  ConsumerState<TextToSpeechHistoryView> createState() =>
      _TextToSpeechHistoryViewState();
}

class _TextToSpeechHistoryViewState
    extends ConsumerState<TextToSpeechHistoryView>
      ...
      body: historyAsync.when(
        ...
        data: (historyList) {
          if (historyList.isEmpty) {
            return const NotFound(type: FeatureType.textToSpeech);
          }
